...
class PriorPreference(nn.Module):
    ...
    def proj(self,dec_out,context,src_hidden,src_mask,pv_m,tp_path):
        ...
        copy_context_prob = probs[:, :,self.n_topic_vocab :self.n_topic_vocab + op.context_max_len]
        ...
        copy_pv_m_prob = probs[:, :, self.n_topic_vocab + op.context_max_len : self.n_topic_vocab + op.context_max_len + op.preference_num ]
...
class PosteriorPreference(nn.Module):
    ...
    def proj(self, dec_out,  src_hidden, src_mask, pv_m , context ,tp ):
        ...
        copy_tp_path_prob = probs[:, :,self.n_topic_vocab + op.context_max_len + op.preference_num :
                                       self.n_topic_vocab + op.context_max_len + op.preference_num + op.state_num]
