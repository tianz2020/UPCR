...
class DataSet():
    ...
    def get_dialog(self):
        if self.args.processed:
            with open('./dataset/train_rec_redial_dbpedia.pkl','rb+') as train_set:
                train = pickle.load(train_set)

            with open('./dataset/valid_rec_redial_dbpedia.pkl','rb+') as valid_set:
                valid = pickle.load(valid_set)

            with open('./dataset/test_rec_redial_dbpedia.pkl', 'rb+') as test_set:
