...
class Response(nn.Module):
    ...
    def proj(self,dec_out,src_hidden,src_mask,context,action,tp):
        ...
        copy_tp_prob = probs[:,:,self.n_vocab + op.context_max_len:self.n_vocab + op.context_max_len + op.state_num_redial]
    ...
    def _beam_search(self,seq_gen, src_hidden, src_mask,
        ...
        for i in range(op.r_max_len):
            if i == 0:
                ...
                src_hidden = expand_if_not_none(src_hidden, 0, self.beam_width)
