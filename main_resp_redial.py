...
from excrsRespRedial import ExcrsResp,EngineResp
...
def main():
    ...
    # with open('./dataset/train_resp_redial_dbpedia_114.pkl', 'wb+') as f:
    #    pickle.dump(train,f)
    #
    # with open('./dataset/valid_resp_redial_dbpedia_114.pkl', 'wb+') as f1:
    #    pickle.dump(valid,f1)
    #
    # with open('./dataset/test_resp_redial_dbpedia_114.pkl', 'wb+') as f2:
    #    pickle.dump(test,f2)


    # dataloader = DataLoaderResp(train,vocab)
    ...
    excrs_topic = ExcrsResp(vocab=vocab,user_cont=user_cont)
    engine = EngineResp(model=excrs_topic,vocab=vocab)
